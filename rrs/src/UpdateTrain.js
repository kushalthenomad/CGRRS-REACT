...
export default function Updatetrain() {
    ...
    useEffect(() => {
        axios.get(`https://localhost:7132/api/TrainInfo/${localStorage.getItem('TrainNumber')}`)
    ...
    function handleSubmit(e){
        ...
        console.log(Data);
        axios.put(`https://localhost:7132/api/Admin/Puttrain/${localStorage.getItem('TrainNumber')}`,Data)
            .then(function (response) {
                console.log(response.data);
